...
INSERT INTO `ddfmemory` (`id`, `name`, `keytype`, `caption`, `adrspace`, `startadr`, `endadr`, `acctype`, `width`, `crtime`) VALUES
	...
	(3, 'Cortex-M0', 'Memory', 'ROM', 'Memory', '0x1FFFEC00', '0x1FFFFBFF', 'W', '', '2019-09-26 10:02:38'),
	(4, 'Cortex-M0', 'Memory', 'RemapMem', 'Memory', '0x00000000', '0x00007FFF', 'W', '', '2019-09-26 10:02:38'),
	...
	(8, 'Cortex-M3', 'Memory', 'ROM', 'Memory', '0x1FFFE000', '0x1FFFF80F', 'W', '', '2019-09-26 10:02:38'),
	...
	(11, 'Cortex-M3', 'Memory', 'RemapMem', 'Memory', '0x00000000', '0x0001FFFF', 'W', '', '2019-09-26 10:02:38'),
...
INSERT INTO `designcode` (`id`, `code`, `corename`, `corever`, `minfreq`, `fpu`, `mpu`, `simd`, `jtag`, `swd`, `swotraced0`, `endian`, `thumbsupport`, `armsupport`, `flashbase`, `rambase`, `intvecbase`, `block`, `page`, `trusterange`, `useSfrfilter`, `online`, `aggregate`, `argsdoc`, `ddfname`, `dmacname`, `crtime`) VALUES
	...
	(5, 'MZ307', 'Cortex-M3', 'r2p1', 144000000, 0, 0, 0, 0, 0, 0, 0, 1, 0, 134217728, 536870912, 134217728, 1024, 2, 1, 1, 1, 1, '--skip_erase -Don\'t erase blocks that read empty.', 'Cortex-M0', 'Cortex-M0', '2019-09-26 10:02:38'),
	(6, 'MZ304', 'Cortex-M3', 'r2p1', 96000000, 0, 0, 0, 0, 0, 0, 0, 1, 0, 134217728, 536870912, 134217728, 1024, 2, 1, 1, 1, 1, '--skip_erase -Don\'t erase blocks that read empty.', 'Cortex-M0', 'Cortex-M0', '2019-09-26 10:02:38');
